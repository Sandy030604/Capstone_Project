...
public class ReportManager {
    ...
    public ExtentTest createTestCase(String name, String description){
        System.out.println("createReport:"+extentReports);
    ...
    public String takeScreenShot(WebDriver driver) throws IOException {
        ...
        String screenshotPath = "C:\\Users\\santhosh.krishnan\\Downloads\\Capstone_Project_MakeMyTrip\\reports\\screenshots"+System.currentTimeMillis()+".png";
    ...
    public void closeReport(){
        System.out.println(extentReports +" "+"hii");
